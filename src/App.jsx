...
function App() {
  ...
  const [isPrincipleInvalid,setIsPrincipleInvalid] = useState(false)  //display control of invalid div
  ...
  const userInputValidation = (inputTag)=>{
    ...
    if(name=="principle"){
      setPrinciple(value)  //use setPrinciple method, value assign to principle state
    ...
    <div style={{minHeight:'100vh'}} className='d-flex justify-content-center align-items-center bg-dark'>
      <div style={{width:'600px'}} className='bg-light rounded p-5'>
        ...
        <form className='mt-3'>
          ...
          {  //conditional rendering, value=true, display
            isPrincipleInvalid && <div className="mb-3 fw-bolder text-danger"> *Inavlid Principle Amount </div>
          }
          ...
          {
            isRateInvalid && <div className="mb-3 fw-bolder text-danger"> *Inavlid Rate </div>
          }
          <div className='mb-3'>
          ...
          {
            isYearInvalid && <div className="mb-3 fw-bolder text-danger"> *Inavlid Year </div>
          }
